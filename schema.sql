...
--
-- Name: active_reports_tracker; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.active_reports_tracker AS
 SELECT c.grant_name,
    r.report_type,
    r.due_date,
    ...
    r.pgm_approved,
    r.director_approved
   FROM ((public.reporting_events r
     JOIN public.contracts c ON ((r.contract_id = c.id)))
     LEFT JOIN public.users u ON ((u.id = c.created_by)))
  WHERE ((r.status)::text <> 'approved'::text);


ALTER VIEW public.active_reports_tracker OWNER TO postgres;
...
--
-- Name: grant_financial_summary; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.grant_financial_summary AS
 SELECT id,
    grant_name,
    total_amount,
    COALESCE(( SELECT sum(((value.value ->> 'amount'::text))::numeric) AS sum
           FROM jsonb_array_elements(c.payment_schedule) value(value)
          WHERE ((value.value ->> 'status'::text) = 'received'::text)), (0)::numeric) AS amount_received,
    (total_amount - (COALESCE(( SELECT sum(((value.value ->> 'amount'::text))::numeric) AS sum
           FROM jsonb_array_elements(c.payment_schedule) value(value)
          WHERE ((value.value ->> 'status'::text) = 'received'::text)), (0)::numeric))::double precision) AS balance_remaining
   FROM public.contracts c
  WHERE (((document_type)::text = 'main_contract'::text) AND (is_latest_version = true));


ALTER VIEW public.grant_financial_summary OWNER TO postgres;

--
-- Name: portfolio_health; Type: VIEW; Schema: public; Owner: postgres
--
 ...
 SELECT grant_name,
        CASE
            WHEN (EXISTS ( SELECT 1
               FROM public.reporting_events r
              WHERE ((r.contract_id = c.id) AND (r.due_date < CURRENT_DATE) AND ((r.status)::text <> 'approved'::text)))) THEN 'At Risk'::text
            ELSE 'On Track'::text
        END AS reporting_status
   FROM public.contracts c
  WHERE ((document_type)::text = 'main_contract'::text);


ALTER VIEW public.portfolio_health OWNER TO postgres;

--
-- Name: executive_grant_snapshot; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.executive_grant_snapshot AS
 SELECT c.grant_name,
    c.grantor,
    c.total_amount,
    gfs.balance_remaining,
    ph.reporting_status
   FROM ((public.contracts c
     LEFT JOIN public.grant_financial_summary gfs ON ((gfs.id = c.id)))
     LEFT JOIN public.portfolio_health ph ON (((ph.grant_name)::text = (c.grant_name)::text)))
  WHERE (((c.document_type)::text = 'main_contract'::text) AND (c.is_latest_version = true));


ALTER VIEW public.executive_grant_snapshot OWNER TO postgres;
...
--
-- Name: grant_risk_exposure; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.grant_risk_exposure AS
 SELECT grant_name,
    'Overdue Reporting'::text AS risk_type,
    total_amount AS financial_exposure
   FROM public.contracts c
  WHERE (EXISTS ( SELECT 1
           FROM public.reporting_events r
          WHERE ((r.contract_id = c.id) AND (r.due_date < CURRENT_DATE) AND ((r.status)::text <> 'approved'::text))));


ALTER VIEW public.grant_risk_exposure OWNER TO postgres;
...
--
-- Name: overdue_reports; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.overdue_reports AS
 SELECT c.grant_name,
    r.report_type,
    r.due_date,
   ...
   FROM (public.reporting_events r
     JOIN public.contracts c ON ((r.contract_id = c.id)))
  WHERE ((r.due_date < CURRENT_DATE) AND ((r.status)::text <> 'approved'::text));


ALTER VIEW public.overdue_reports OWNER TO postgres;

--
-- Name: portfolio_financial_overview; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.portfolio_financial_overview AS
...
ALTER VIEW public.portfolio_financial_overview OWNER TO postgres;
...
--
-- Name: upcoming_reports_30_days; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.upcoming_reports_30_days AS
 SELECT grant_name,
    report_type,
    due_date,
    days_remaining,
    ...
    pgm_approved,
    director_approved
   FROM public.active_reports_tracker
  WHERE ((due_date >= CURRENT_DATE) AND (due_date <= (CURRENT_DATE + '30 days'::interval)));


ALTER VIEW public.upcoming_reports_30_days OWNER TO postgres;
...
--
-- Name: tenant_modules tenant_modules_tenant_id_module_key_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: idx_review_comments_tenant_id; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_review_comments_tenant_id ON public.review_comments USING btree (tenant_id);
...
--
-- Name: amendment_comparisons amendment_comparisons_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.amendment_comparisons
    ADD CONSTRAINT amendment_comparisons_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);
...
--
-- Name: comment_attachments comment_attachments_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.comment_attachments
    ADD CONSTRAINT comment_attachments_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);
...
--
-- Name: comment_reactions comment_reactions_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.comment_reactions
    ADD CONSTRAINT comment_reactions_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);
...
--
-- Name: comment_tags comment_tags_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.comment_tags
    ADD CONSTRAINT comment_tags_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);
...
--
-- Name: contract_deliverables contract_deliverables_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.contract_deliverables
    ADD CONSTRAINT contract_deliverables_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);
...
--
-- Name: contract_permissions contract_permissions_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.contract_permissions
    ADD CONSTRAINT contract_permissions_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);
...
--
-- Name: contract_versions contract_versions_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.contract_versions
    ADD CONSTRAINT contract_versions_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);
...
--
-- Name: extraction_logs extraction_logs_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.extraction_logs
    ADD CONSTRAINT extraction_logs_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);
...
--
-- Name: reporting_events reporting_events_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.reporting_events
    ADD CONSTRAINT reporting_events_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);
...
--
-- Name: reporting_schedules reporting_schedules_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.reporting_schedules
    ADD CONSTRAINT reporting_schedules_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);
...
--
-- Name: review_comments review_comments_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.review_comments
    ADD CONSTRAINT review_comments_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id);
...
--
-- Name: user_notifications user_notifications_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: contracts tenant_isolation_policy; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY tenant_isolation_policy ON public.contracts USING ((tenant_id = (current_setting('app.tenant_id'::text))::uuid));
...
\unrestrict kBTvDePSFmzm1ebKmSaLsdJCCHP2HttzAUUcSJHVPEJMwbj8r4137cK73JR71B6
