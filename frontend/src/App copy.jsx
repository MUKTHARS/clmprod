...
import { ModuleContext } from "./pages/ModuleContext";
  ...
  if (!isAuthenticated) {
    return (
      <Routes>
        ...
        <Route path="/setup/modules" element={<ModuleSelectionPage />} />
        <Route path="/setup/workflow" element={<WorkflowPage />} />
      </Routes>
    );
  }
...
function App() {
    ...
    const fetchModules = async () => {
      ...
      try {
        const res = await fetch(
          `${API_CONFIG.BASE_URL}/api/modules/my`,
          {
            headers: {
  ...
  return (
    <Router>
      <ModuleContext.Provider value={enabledModules}>
        <div className="app-container">
          <AppContent 
            user={user}
