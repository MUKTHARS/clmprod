...
//     if (activeTab === 'my-drafts') {
//       // ✅ FIX: Call the correct endpoint for "My Drafts"
//       try {
//         const response = await fetch(`${API_CONFIG.BASE_URL}/api/agreements/drafts`, {
//           headers: {
//             'Authorization': `Bearer ${token}`,
...
//           // ✅ Filter to show only drafts created by current user
//           const myDrafts = data.filter(draft => {
//             if (!draft) return false;
            
//             // Check if draft was created by current user
//             const isCreator = draft.created_by === user?.id;
...
//       }
//     } else {
//       // Use the new fixed endpoint for assigned drafts
//       try {
//         const response = await fetch(`${API_CONFIG.BASE_URL}/api/agreements/assigned-drafts`, {
//           headers: {
//             'Authorization': `Bearer ${token}`,
...
//   {drafts.filter(d => {
//     if (!d) return false;
//     return d.created_by === user?.id || d.userId === user?.id;
//   }).length}
// </span>
//         </button>
//         <button
