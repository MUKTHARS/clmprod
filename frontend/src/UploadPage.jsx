...
//       // Show success alert
//       alert(`✅ Contract saved to drafts successfully! Contract ID: ${response.data.id}`);
      
//       // Store in localStorage for draft management
//       const drafts = JSON.parse(localStorage.getItem('user_drafts') || '[]');
//       drafts.push({
//         id: response.data.id,
//         filename: response.data.filename,
//         grant_name: response.data.grant_name,
...
//       // Don't navigate, show extraction results instead
//       // Remove this line:
//       // navigate(`/contracts/${response.data.id}`);
//     }
    
//     // Call onUploadComplete if needed
//     if (onUploadComplete) {
//       onUploadComplete(response.data);
//     }
...
// // Add a new function to handle viewing draft
// const handleViewDraft = (contractId) => {
//   navigate(`/contracts/${contractId}`);
// };

// // Add a new function to continue uploading
...
//             <span className="info-value">{extractedData.contractName}</span>
//           </div>
//           <div className="info-row">
//             <span className="info-label">Total Amount:</span>
//             <span className="info-value">{extractedData.totalAmount}</span>
//           </div>
//           <div className="info-row">
//             <span className="info-label">Contract ID:</span>
//             <span className="info-value">{extractedData.id}</span>
//           </div>
//           <div className="info-row">
//             <span className="info-label">Status:</span>
//             <span className="info-value status-draft">Draft</span>
//           </div>
//         </div>
//       </div>
...
//         <button 
//           className="btn-primary"
//           onClick={() => handleViewDraft(extractedData.id)}
//         >
//           View Draft
//         </button>
//       </div>
