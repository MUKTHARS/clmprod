    ...
    <div className="workflow-btn-group">
      ...
      {popup.show && (
        <div className="workflow-popup-overlay">
          <div className={`workflow-popup workflow-popup-${popup.type}`}>
            <div className="workflow-popup-header">
              ...
              <h3>{popup.title}</h3>
              <button className="workflow-popup-close" onClick={closePopup}>
                <X size={18} />
              </button>
            </div>
            ...
            <div className="workflow-popup-actions">
              {popup.type === 'confirm' ? (
                <>
                  <button 
                    className="workflow-popup-btn workflow-popup-btn-cancel"
                    onClick={popup.onCancel || closePopup}
                  >
                    Cancel
                  </button>
                  <button 
                    className="workflow-popup-btn workflow-popup-btn-confirm"
                ...
                <button 
                  className="workflow-popup-btn workflow-popup-btn-ok"
                  onClick={closePopup}
                >
                  OK
                </button>
...
//     if (response.ok) {
//       const result = await response.json();
//       // alert(result.message || 'Draft updated successfully!'); // ✅ Commented out - no need for success alert
